const Kitchenessentials = require("../Model/KitchenEssentials_Model")
...
exports.create = async (req, res) => {
    ...
    try {
      const kitchen = new Kitchenessentials({name, price, offer, size, quantity, image });
    ...
    exports.getAll = async (req, res) => {
        try {
          const  KitchenEssentials = await Kitchenessentials.find();
      
      
          const formattedItems = KitchenEssentials.map(item => {
          ...
          res.json({  KitchenEssentials: formattedItems });
        } catch (err) {
    ...
    exports.delete = (req, res) => {
        ...
        Kitchenessentials.findByIdAndDelete(id)
            .then(data => {
                if (!data) {
